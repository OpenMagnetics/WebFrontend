...
export const TOURS = {
    ...
    home: {
        steps: [
            ...
            ...headerSteps.slice(0, 2),
            {
                element: '[data-cy^="Home-topology-"]',
                title: 'Pick your converter',
                description: 'These cards jump straight into the design wizard for each converter topology — the quickest path from an electrical spec to a finished magnetic.',
            },
            ...headerSteps.slice(2),
        ],
    },
