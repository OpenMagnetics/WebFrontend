            ...
            <div class="container">
                ...
                <div class="row mb-2 mt-5">
                    <div class="col-12 text-center">
                        <h2 class="text-white display-6 fw-bold"><i class="bi bi-lightning-fill text-warning me-3"></i><i class="bi bi-magnet-fill text-info me-3"></i>Magnetics Design Tools</h2>
                ...
                <div class="row g-4 mb-5 px-3">
                                ...
                                <div class="row h-100">
                                    <div class="col-lg-7">
                                        <div class="d-flex align-items-center mb-3">
                                            <i class="bi bi-magnet-fill fa-2x text-primary me-3"></i>
                                        ...
                                        <div class="text-white fs-6">
                                            <div class="mb-1"><i class="bi bi-fire text-danger me-2"></i>Core & winding losses</div>
                                            <div class="mb-1"><i class="bi bi-thermometer-high text-warning me-2"></i>Temperature simulation & thermal analysis</div>
                                            <div class="mb-1"><i class="bi bi-lightning-fill text-info me-2"></i>Leakage inductance (Llk) matrix</div>
                                            <div class="mb-1"><i class="bi bi-soundwave text-success me-2"></i>Stray capacitance & parasitic analysis</div>
                                            <div class="mb-1"><i class="bi bi-cpu text-purple me-2"></i>Equivalent circuit export (SPICE)</div>
                                        </div>
                                        <button @click="newMagneticToolDesign" @click.middle="newMagneticToolDesignNewTab" class="btn btn-primary btn-lg mt-3 shadow">
                                            <i class="bi bi-hammer me-2"></i>Start Building
                                        </button>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card h-100 border-0 shadow home-tool-card">
                            <div class="card-body p-4">
                                <i class="bi bi-magic fa-2x text-primary mb-3"></i>
                                ...
                                <button @click="onWizardsLanding" class="btn om-home-btn w-100 mt-2">
                                    <i class="bi bi-magic me-2"></i>Launch Wizards
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow home-tool-card">
                            <div class="card-body p-4">
                                <i class="bi bi-shield-shaded fa-2x text-primary mb-3"></i>
                                ...
                                <div class="text-white small">
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>IEC 60664</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>IEC 62368</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>IEC 61558</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>IEC 60335</div>
                                </div>
                                <button @click="onInsulationCoordinator" @click.middle="onInsulationCoordinatorNewTab" class="btn om-home-btn w-100 mt-2">
                                    <i class="bi bi-lightning-charge-fill me-2"></i>Calculate Insulation
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow home-tool-card">
                            <div class="card-body p-4">
                                <i class="bi bi-soundwave fa-2x text-primary mb-3"></i>
                                ...
                                <div class="text-white small">
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Automated circuit netlist generation</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Simulate converter topologies</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Export magnetic subcircuits</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Waveform visualization</div>
                                </div>
                                <button @click="onWizardsLanding" class="btn om-home-btn w-100 mt-2">
                                    <i class="bi bi-beaker me-2"></i>Run Simulation
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow home-tool-card">
                            <div class="card-body p-4">
                                <i class="bi bi-diagram-3-fill fa-2x text-primary mb-3"></i>
                                <h4 class="card-title text-white fw-bold">Equivalent Circuit</h4>
                                <p class="card-text text-white">Export accurate SPICE models:</p>
                                <div class="text-white small">
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>SIMBA format</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>LtSpice format</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>NgSpice format</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Temperature-dependent parameters</div>
                                </div>
                                <button @click="newMagneticToolDesign" class="btn om-home-btn w-100 mt-2">
                                    <i class="bi bi-download me-2"></i>Export Subcircuit
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow home-tool-card">
                            <div class="card-body p-4">
                                <i class="bi bi-thermometer-high fa-2x text-primary mb-3"></i>
                                ...
                                <div class="text-white small">
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Core loss vs temperature</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Winding resistance vs temperature</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Magnetizing inductance vs temperature</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Thermal resistance modeling</div>
                                </div>
                                <button @click="newMagneticToolDesign" class="btn om-home-btn w-100 mt-2">
                                    <i class="bi bi-thermometer-sun me-2"></i>Analyze Thermal
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow home-tool-card">
                            <div class="card-body p-4">
                                <i class="bi bi-unlock-fill fs-2 text-primary mb-3"></i>
                                ...
                                <div class="text-white small">
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>See exactly how every calculation works</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Run it locally on your own machine</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Contribute improvements and new features</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Use it in your own projects</div>
                                </div>
                ...
                <div id="home-how-whom" class="row py-5 border-top border-bottom bg-transparent">
                    <div class="col-12 text-center mb-4">
                        <h2 class="text-white display-6 fw-bold"><i class="bi bi-people-fill text-primary me-3"></i>Built For Power Electronics Engineers</h2>
                    </div>
                        ...
                        <div class="card h-100 border-0 shadow home-tool-card">
                            <div class="card-header bg-transparent border-bottom border-secondary text-center py-3">
                                <h3 class="text-white mb-0">
                                    <i class="bi bi-beaker text-secondary me-2"></i>Researchers
                                </h3>
                            </div>
                            <div class="card-body">
                                <div class="text-white">
                                    <div class="mb-1"><i class="bi bi-check-lg text-secondary me-2"></i>Compare your models against state of the art</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-secondary me-2"></i>Access curated datasets for model development</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-secondary me-2"></i>Contribute to a living, used platform</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-secondary me-2"></i>Validation-based community, not marketing</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100 border-0 shadow home-tool-card">
                            <div class="card-header bg-transparent border-bottom border-primary text-center py-3">
                                <h3 class="text-white mb-0">
                                    <i class="bi bi-tools text-primary me-2"></i>Design Engineers
                                </h3>
                            </div>
                            <div class="card-body">
                                <div class="text-white">
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Latest and most accurate loss models</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>No black boxes - see the implementation</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>Export designs without registration</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-primary me-2"></i>All commercial parts from major vendors</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100 border-0 shadow home-tool-card">
                            <div class="card-header bg-transparent border-bottom border-info text-center py-3">
                                <h3 class="text-white mb-0">
                                    <i class="bi bi-building-fill text-info me-2"></i>Manufacturers
                                </h3>
                            </div>
                            <div class="card-body">
                                <div class="text-white">
                                    <div class="mb-1"><i class="bi bi-check-lg text-info me-2"></i>Reduce prototyping iterations</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-info me-2"></i>Use your own stock in designs</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-info me-2"></i>Integrate your products in our database</div>
                                    <div class="mb-1"><i class="bi bi-check-lg text-info me-2"></i>Access data from all distributors</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row py-5">
                    <div class="col-12 text-center mb-4">
                        <h2 class="text-white display-6 fw-bold"><i class="bi bi-building text-warning me-3"></i>Supported Manufacturers</h2>
                        ...
                        <div class="card bg-gradient border-0 shadow-lg p-5" style="background: linear-gradient(135deg, #1e3a5f 0%, #0d1b2a 100%);">
                            ...
                            <div class="d-flex justify-content-center gap-3 flex-wrap">
                                <button @click="newMagneticToolDesign" class="btn btn-primary btn-lg shadow">
                                    <i class="bi bi-rocket-takeoff-fill me-2"></i>Launch Magnetic Builder
                                </button>
