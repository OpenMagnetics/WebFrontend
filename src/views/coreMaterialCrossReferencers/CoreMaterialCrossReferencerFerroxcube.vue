...
import '/src/assets/css/ferroxcube.css'
...
<template>
    <CoreMaterialCrossReferencer :onlyManufacturer="'Ferroxcube'" loadingGif="/images/loading_ferroxcube.gif" suffix="_ferroxcube"/>
</template>
