...
import '/src/assets/css/micrometals.css'
...
<template>
    <CoreMaterialCrossReferencer :onlyManufacturer="'Micrometals'" loadingGif="/images/loading_micrometals.gif" suffix="_micrometals"/>
</template>
