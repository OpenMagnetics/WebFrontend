...
if (Module["locateFile"]) {
 wasmBinaryFile = "libCoreAdviser.wasm.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("libCoreAdviser.wasm.wasm", import.meta.url).href;
}
  ...
  case 21505:
   {
    ...
    if (stream.tty.ops.ioctl_tcgets) {
     ...
     for (var i = 0; i < 32; i++) {
      SAFE_HEAP_STORE((((argp + i) + (17)) >>> 0) >>> 0, termios.c_cc[i] || 0, 1);
  ...
  case 21508:
   {
    ...
    if (stream.tty.ops.ioctl_tcsets) {
     ...
     var c_cc = [];
     for (var i = 0; i < 32; i++) {
      c_cc.push(SAFE_HEAP_LOAD((((argp + i) + (17)) >>> 0) >>> 0, 1, 0));
     }
...
function _strftime(s, maxsize, format, tm) {
 ...
 format >>>= 0;
 tm >>>= 0;
 var tm_zone = SAFE_HEAP_LOAD(((((tm) + (40)) >>> 2) >>> 0) * 4, 4, 1);
 var date = {
  tm_sec: SAFE_HEAP_LOAD((((tm) >>> 2) >>> 0) * 4, 4, 0),
  tm_min: SAFE_HEAP_LOAD(((((tm) + (4)) >>> 2) >>> 0) * 4, 4, 0),
  tm_hour: SAFE_HEAP_LOAD(((((tm) + (8)) >>> 2) >>> 0) * 4, 4, 0),
  tm_mday: SAFE_HEAP_LOAD(((((tm) + (12)) >>> 2) >>> 0) * 4, 4, 0),
  tm_mon: SAFE_HEAP_LOAD(((((tm) + (16)) >>> 2) >>> 0) * 4, 4, 0),
  tm_year: SAFE_HEAP_LOAD(((((tm) + (20)) >>> 2) >>> 0) * 4, 4, 0),
  tm_wday: SAFE_HEAP_LOAD(((((tm) + (24)) >>> 2) >>> 0) * 4, 4, 0),
  tm_yday: SAFE_HEAP_LOAD(((((tm) + (28)) >>> 2) >>> 0) * 4, 4, 0),
  tm_isdst: SAFE_HEAP_LOAD(((((tm) + (32)) >>> 2) >>> 0) * 4, 4, 0),
  tm_gmtoff: SAFE_HEAP_LOAD(((((tm) + (36)) >>> 2) >>> 0) * 4, 4, 0),
