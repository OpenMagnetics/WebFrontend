...
export default {
    ...
    mounted () {
      ...
      y: {
        ...
        // console.log(this.masData.magnetic.manufacturerInfo.reference)
        ...
        console.log("mounted" + this.adviseIndex)
    },
    methods: {
...
<template>
    <div class="container">
        <div class="card p-0 m-0">
            ...
            <div class="card-body">
                <button :data-cy="dataTestLabel + '-advise-' + adviseIndex + '-details-button'" class="btn btn-primary col-3" data-bs-toggle="offcanvas" data-bs-target="#CoreAdviserDetailOffCanvas" @click="$emit('selectedMas')"> Details </button>
                <button :data-cy="dataTestLabel + '-advise-' + adviseIndex + '-select-button'" class="btn btn-primary offset-1 col-3" @click="$emit('selectedMas')">Select</button>
            </div>
        </div>
    </div>
</template>
