...
<template>
  ...
  >
    ...
    <template #design-or-switch-parameters>
      ...
      <Dimension v-if="localData.overrideSeriesInductance" :name="'seriesInductance'" :tooltip="tooltipsConverterWizards['seriesInductance']" :replaceTitle="'Series Ind.'" unit="H" :min="minimumMaximumScalePerParameter['inductance']['min']" :max="minimumMaximumScalePerParameter['inductance']['max']" v-model="localData" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'transparent'" :valueBgColor="$styleStore.wizard.inputValueBgColor" :textColor="$styleStore.wizard.inputTextColor" @update="updateErrorMessage"/>
      ...
      <Dimension v-if="localData.overrideResonantCapacitance" :name="'resonantCapacitance'" :tooltip="tooltipsConverterWizards['resonantCapacitance']" :replaceTitle="'Resonant Cap.'" unit="F" :min="1e-12" :max="1e-3" v-model="localData" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'transparent'" :valueBgColor="$styleStore.wizard.inputValueBgColor" :textColor="$styleStore.wizard.inputTextColor" @update="updateErrorMessage"/>
    </template>
    ...
    <template v-if="llcDiagnostics" #diagnostics>
      ...
      <DimensionReadOnly :name="'llcLs'" :tooltip="tooltipsConverterWizards['llcLs']" :replaceTitle="'Series Ind.'" unit="H" :value="llcDiagnostics.computedResonantInductance" :numberDecimals="6" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      ...
      <DimensionReadOnly :name="'llcLipFreq'" :tooltip="tooltipsConverterWizards['llcLipFreq']" :replaceTitle="'LIP freq'" unit="Hz" :value="llcDiagnostics.lipFrequency" :numberDecimals="0" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly :name="'llcLipVin'" :tooltip="tooltipsConverterWizards['llcLipVin']" :replaceTitle="'LIP Vin'" unit="V" :value="llcDiagnostics.lipInputVoltage" :numberDecimals="1" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly :name="'llcResidual'" :tooltip="tooltipsConverterWizards['llcResidual']" :replaceTitle="'Residual'" :unit="null" :value="llcDiagnostics.lastSteadyStateResidual" :numberDecimals="6" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="llcDiagnostics.lastSteadyStateResidual > 1e-4 ? 'text-warning' : $styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly v-if="llcDiagnostics.lastSubStateSequence && llcDiagnostics.lastSubStateSequence.length" :name="'llcSubStates'" :tooltip="tooltipsConverterWizards['llcSubStates']" :replaceTitle="'Sub-states'" :unit="null" :value="llcDiagnostics.lastSubStateSequence.join(' → ')" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
    </template>
    ...
    <template #outputs>
      <div class="mb-2">
        <ElementFromList :name="'numberOutputs'" :tooltip="tooltipsConverterWizards['numberOutputs']" :replaceTitle="'Number of Outputs'" :options="Array.from({length: 10}, (_, i) => i + 1)" :titleSameRow="true" v-model="localData" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'transparent'" :valueBgColor="$styleStore.wizard.inputValueBgColor" :textColor="$styleStore.wizard.inputTextColor" @update="updateNumberOutputs"/>
      </div>
