...
<template>
  <ConverterWizardBase
    ...
    :titleIcon="converterName === 'Isolated Buck' ? 'bi bi-shield-fill' : 'bi bi-shield-shaded'"
  ...
  >
    ...
    <template #design-or-switch-parameters-title>
      <div class="compact-header"><i class="bi bi-gear-wide-connected me-1"></i>{{localData.designLevel == 'I know the design I want' ? "Design Params" : "Switch"}}</div>
    </template>
