...
export default {
  ...
  data() {
    ...
    const localData = {
      ...
      phaseShift: 0.4, maxPhaseShift: 0.8, efficiency: 0.95,
  ...
  methods: {
    ...
    getSimulateFn() { return (aux) => this.taskQueueStore.calculatePshbInputs(aux); },
    getDefaultFrequency() { return this.localData.switchingFrequency; },
    getTopology() { return 'Phase-Shifted Half-Bridge Converter'; },
