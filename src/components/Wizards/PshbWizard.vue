...
<template>
  <ConverterWizardBase
    ref="base"
    title="PSHB Wizard" titleIcon="bi bi-chevron-double-right"
  ...
  >
    ...
    <template v-if="pshbDiagnostics" #diagnostics>
      <DimensionReadOnly name="pshbEffectiveDuty" :tooltip="tooltipsConverterWizards['pshbEffectiveDuty']" :replaceTitle="'D effective'" :value="pshbDiagnostics.effectiveDutyCycle" :unit="null" :numberDecimals="3" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly name="pshbDutyLoss" :tooltip="tooltipsConverterWizards['pshbDutyLoss']" :replaceTitle="'D loss'" :value="pshbDiagnostics.dutyCycleLoss" :unit="null" :numberDecimals="3" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly name="pshbZvsLagging" :tooltip="tooltipsConverterWizards['pshbZvsLagging']" :replaceTitle="'ZVS lagging'" :value="pshbDiagnostics.zvsMarginLagging" :unit="null" :numberDecimals="3" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="pshbDiagnostics.zvsMarginLagging <= 0 ? 'text-warning' : $styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly name="pshbZvsLoadThr" :tooltip="tooltipsConverterWizards['pshbZvsLoadThr']" :replaceTitle="'ZVS load thr'" :value="pshbDiagnostics.zvsLoadThreshold" unit="A" :numberDecimals="3" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly name="pshbResTrans" :tooltip="tooltipsConverterWizards['pshbResTrans']" :replaceTitle="'t resonant'" :value="pshbDiagnostics.resonantTransitionTime" unit="s" :numberDecimals="9" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly name="pshbPriPeak" :tooltip="tooltipsConverterWizards['pshbPriPeak']" :replaceTitle="'I pri peak'" :value="pshbDiagnostics.primaryPeakCurrent" unit="A" :numberDecimals="3" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly name="pshbLseries" :tooltip="tooltipsConverterWizards['pshbLseries']" :replaceTitle="'L series'" :value="pshbDiagnostics.computedSeriesInductance" unit="H" :numberDecimals="9" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly name="pshbLout" :tooltip="tooltipsConverterWizards['pshbLout']" :replaceTitle="'L output'" :value="pshbDiagnostics.computedOutputInductance" unit="H" :numberDecimals="9" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
      <DimensionReadOnly name="pshbLmag" :tooltip="tooltipsConverterWizards['pshbLmag']" :replaceTitle="'L mag'" :value="pshbDiagnostics.computedMagnetizingInductance" unit="H" :numberDecimals="9" :labelWidthProportionClass="'col-5'" :valueWidthProportionClass="'col-7'" :valueFontSize="$styleStore.wizard.inputFontSize" :labelFontSize="$styleStore.wizard.inputLabelFontSize" :labelBgColor="'bg-transparent'" :valueBgColor="'bg-transparent'" :textColor="$styleStore.wizard.inputTextColor"/>
