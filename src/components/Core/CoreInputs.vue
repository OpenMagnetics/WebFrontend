        ...
        this.coreStore.$onAction((action) => {
            if (action.name == "commercialShapesLoaded") {
                ...
                shapeData.forEach((item) => {
                    this.commercialShapesNames.push(item['functionalDescription']['shape']['name'])
                })
    ...
    methods: {
        onShapeChange () {
            ...
            this.coreStore.commercialShapes.forEach((item) => {
                if (item['functionalDescription']['shape']['name'] == this.simpleShapeSelected) {
                    shapeDataSelected = Utils.deepCopy(item['functionalDescription']['shape'])
                }
            })
            this.userStore.setGlobalCoreShapeFromSelector(shapeDataSelected)
