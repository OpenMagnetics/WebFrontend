...
<template>
    <div v-tooltip="styleTooltip" class="container-flex text-white mt-2 mb-3 pb-3 border-top me-2">
        <div class="row">
            ...
            <input data-test="CoreShapeArtisanOptions-full-core-button" v-model="fullCoreModelSelected" @change="OnChange" type="range" class="mt-2 form-range offset-1 col-1" min="0" max="1" step="1" style="width: 30px">
