    ...
    <div v-tooltip="styleTooltip" class="container-flex text-white mt-2 mb-3 pb-3 border-bottom me-2">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-12">
                ...
                <label data-test="CoreShapeArtisanOutput-effectiveLength-text" class="fs-5 bg-dark text-white float-end" style=" text-align:right;">{{effectiveLength + ' mm'}}</label>
            </div>
            <div class="col-xl-6 col-lg-12">
                ...
                <label data-test="CoreShapeArtisanOutput-effectiveArea-text" class="fs-5 bg-dark text-white float-end" style=" text-align:right;">{{effectiveArea + ' mm²'}}</label>
            </div>
            <div class="col-xl-6 col-lg-12">
                ...
                <label data-test="CoreShapeArtisanOutput-effectiveVolume-text" class="fs-5 bg-dark text-white float-end" style=" text-align:right;">{{effectiveVolume + ' mm³'}}</label>
            </div>
            <div class="col-xl-6 col-lg-12">
                ...
                <label data-test="CoreShapeArtisanOutput-minimumArea-text" class="fs-5 bg-dark text-white float-end" style=" text-align:right;">{{minimumArea + ' mm²'}}</label>
            </div>
        </div>
    </div>
</template>
