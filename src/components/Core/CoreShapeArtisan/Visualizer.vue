...
<template>
    <img data-test-id="CoreShapeArtisanVisualizer-loading" v-if="posting" class="mx-auto d-block col-12" alt="loading" style="width: 60%; height: auto;" src="/images/loading.gif">
    <Renderer data-test-id="CoreShapeArtisanVisualizer-canvas" ref="renderer" resize=true :orbit-ctrl="{ enableDamping: true, dampingFactor: 0.05, autoRotate : true }" shadow>
        <Camera ref="camera" />
