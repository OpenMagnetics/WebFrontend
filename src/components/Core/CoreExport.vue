...
<template>
    ...
    <div v-tooltip="styleTooltip" class="offcanvas-body">
        <div class="accordion " id="accordionCoreExportAdvancedOptions">
            <div class="border-primary accordion-item bg-light">
                <h2 class="accordion-header bg-light" id="headingOne">
                    <button data-cy="CoreExport-configuration-button" class="accordion-button bg-light text-primary border-primary collapsed fs-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        Configuration
                    </button>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse bg-light text-primary" aria-labelledby="headingOne" data-bs-parent="#accordionAdvancedOptions">
                    <div class="container-flex bg-light text-white mt-2 mb-3 pb-3 me-2">
                        <div class="row">
                            ...
                            <input data-cy="CoreExport-configuration-includeEffectiveParameters-button" v-model="includeEffectiveParametersPicked" type="range" class="mt-2 form-range col-1" min="0" max="1" step="1" style="width: 30px">
                    ...
                    <div class="container-flex bg-light text-white mt-2 mb-3 pb-3 me-2">
                        <div class="row">
                            <i class="fa-solid fa-xmark mt-2 pt-1 ps-2 text-danger offset-1 col-1 p-0"></i>
                            <input data-cy="CoreExport-configuration-includeShapeDimensionsData-button" v-model="includeShapeDimensionsDataPicked" type="range" class="mt-2 form-range col-1" min="0" max="1" step="1" style="width: 30px">
                            <i class="fa-solid fa-check mt-2 pt-1 text-success col-1 ps-3"></i>
                    ...
                    <div class="container-flex bg-light text-white mt-2 mb-3 pb-3 me-2">
                        <div class="row">
                            <i class="fa-solid fa-xmark mt-2 pt-1 ps-2 text-danger offset-1 col-1 p-0"></i>
                            <input data-cy="CoreExport-configuration-includeMaterialData-button" v-model="includeMaterialDataPicked" type="range" class="mt-2 form-range col-1" min="0" max="1" step="1" style="width: 30px" @change="requestedMaterialData"> 
                            <i class="fa-solid fa-check mt-2 pt-1 text-success col-1 ps-3"></i>
                    ...
                    <div class="container-flex bg-light text-white mt-2 mb-3 pb-3 me-2">
                        <div class="row">
                            <i class="fa-solid fa-xmark mt-2 pt-1 ps-2 text-danger offset-1 col-1 p-0"></i>
                            <input data-cy="CoreExport-configuration-includeGeometricalData-button" v-model="includeGeometricalDataPicked" type="range" class="mt-2 form-range col-1" min="0" max="1" step="1" style="width: 30px">
                            <i class="fa-solid fa-check mt-2 pt-1 text-success col-1 ps-3"></i>
                    ...
                    <div class="container-flex bg-light text-white mt-2 mb-3 pb-3 me-2">
                        <div class="row">
                            <i class="fa-solid fa-xmark mt-2 pt-1 ps-2 text-danger offset-1 col-1 p-0"></i>
                            <input data-cy="CoreExport-configuration-includeMaximumDimensions-button" v-model="includeMaximumDimensionsPicked" type="range" class="mt-2 form-range col-1" min="0" max="1" step="1" style="width: 30px">
                            <i class="fa-solid fa-check mt-2 pt-1 text-success col-1 ps-3"></i>
                    ...
                    <div class="container-flex bg-light text-white mt-2 mb-3 pb-3 me-2">
                        <div class="row">
                            <i class="fa-solid fa-xmark mt-2 pt-1 ps-2 text-danger offset-1 col-1 p-0"></i>
                            <input data-cy="CoreExport-configuration-includeAdvancedGapData-button" v-model="includeAdvancedGapDataPicked" type="range" class="mt-2 form-range col-1" min="0" max="1" step="1" style="width: 30px">
                            <i class="fa-solid fa-check mt-2 pt-1 text-success col-1 ps-3"></i>
                    ...
                    <div class="container-flex bg-light text-white mt-2 mb-3 pb-3 me-2">
                        <div class="row">
                            <i class="fa-solid fa-xmark mt-2 pt-1 ps-2 text-danger offset-1 col-1 p-0"></i>
                            <input data-cy="CoreExport-configuration-includeAdvancedColumnData-button" v-model="includeAdvancedColumnDataPicked" type="range" class="mt-2 form-range col-1" min="0" max="1" step="1" style="width: 30px">
                            <i class="fa-solid fa-check mt-2 pt-1 text-success col-1 ps-3"></i>
                    ...
                    <div class="container-flex bg-light text-white mt-2 mb-3 pb-3 me-2">
                        <div class="row">
                            <i class="fa-solid fa-xmark mt-2 pt-1 ps-2 text-danger offset-1 col-1 p-0"></i>
                            <input data-cy="CoreExport-configuration-includeAdvancedWindingWindowData-button" v-model="includeAdvancedWindingWindowDataPicked" type="range" class="mt-2 form-range col-1" min="0" max="1" step="1" style="width: 30px">
                            <i class="fa-solid fa-check mt-2 pt-1 text-success col-1 ps-3"></i>
                    ...
                    <div class="container-flex bg-light text-white mt-2 mb-3 pb-3 me-2">
                        <div class="row">
                            <i class="fa-solid fa-xmark mt-2 pt-1 ps-2 text-danger offset-1 col-1 p-0"></i>
                            <input data-cy="CoreExport-configuration-downloadOnlyPiece-button" v-model="downloadOnlyPiecePicked" type="range" class="mt-2 form-range col-1" min="0" max="1" step="1" style="width: 30px">
                            <i class="fa-solid fa-check mt-2 pt-1 text-success col-1 ps-3"></i>
        ...
        <div class="container">
            <div class="row">
                <button data-cy="CoreExport-export-MAS-button" class="mt-5 btn text-light bg-primary float-start fs-5 px-4 col-12" :disabled="MASexported" @click="onExport">{{MASexported? 'Exported' : 'Export data (MAS format)'}}</button>
                <button data-cy="CoreExport-export-STP-button" class="mt-3 btn text-light bg-primary float-start fs-5 px-4 col-12" :disabled="STPexported" @click="onExportSTP">{{STPexported? 'Exported' : 'Export 3D (STP format)'}}</button>
                <button data-cy="CoreExport-export-OBJ-button" class="mt-3 btn text-light bg-primary float-start fs-5 px-4 col-12" :disabled="OBJexported" @click="onExportOBJ">{{OBJexported? 'Exported' : 'Export 3D (OBJ format)'}}</button>
