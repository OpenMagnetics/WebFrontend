                ...
                <vue-good-table
                    ...
                    <template #table-row="props">
                        <span v-if="props.column.field == 'load'">
                            <button :data-test="'CoreLoadCommercialMaterial-' + props.row.name + '-load-button'" type="button" class="btn btn-primary"  data-bs-dismiss="modal" @click="onLoad(props.row.name)"><i class="fa-solid fa-upload"></i></button>
                        </span>
                    </template>
                </vue-good-table>
            </div>
