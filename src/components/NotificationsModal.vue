        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content bg-dark text-white">
                <div class="modal-header">
                    <p data-test-id="NotificationsModal-notification-text" class="modal-title fs-5" id="notificationsModalLabel">{{currentNotification["name"]}}</p>
                ...
                <div class="modal-body row mt-4">
                    ...
                    <button data-test-id="NotificationsModal-accept-button" class="btn btn-primary mx-auto d-block mt-5 offset-1 col-5" data-bs-dismiss="modal" >Understood</button>
                </div>
            </div>
        </div>
    </div>
