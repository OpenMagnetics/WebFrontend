...
<template>
    <div class="container-flex text-white mt-2 mb-3 pb-3 border-bottom me-2">
            ...
            <label :data-cy="'WaveformOutput-' + electricalParameter + '-peakToPeak-text'" class="fs-5 bg-dark text-white float-end" style="width: 100%; max-width: 60px; text-align:right;">{{peakToPeak}}</label>

            <div></div>

            <label class="fs-5 ms-3">DC Offset:</label>
            <label class="fs-5 ms-2 me-4 float-end" style="width: 10px;">{{electricalParameter == "current"? 'A' : 'V'}}</label>
            <label :data-cy="'WaveformOutput-' + electricalParameter + '-dcOffset-text'" class="fs-5 bg-dark text-white float-end" style="width: 100%; max-width: 60px; text-align:right;">{{dcOffset}}</label>

            <div></div>

            <label class="fs-5 ms-3">RMS:</label>
            <label class="fs-5 ms-2 me-4 float-end" style="width: 10px;">{{electricalParameter == "current"? 'A' : 'V'}}</label>
            <label :data-cy="'WaveformOutput-' + electricalParameter + '-rms-text'" class="fs-5 bg-dark text-white float-end" style="width: 100%; max-width: 60px; text-align:right;">{{rms}}</label>
            ...
            <label :data-cy="'WaveformOutput-' + electricalParameter + '-effectiveSwitchingFrequency-text'" class="fs-5 bg-dark text-white float-end" style="width: 100%; max-width: 60px; text-align:right;">{{effectiveSwitchingFrequency}}</label>

            <div></div>

            <label class="fs-5 ms-3">THD:</label>
            <label class="fs-5 ms-2 me-4 float-end" style="width: 10px;">%</label>
            <label :data-cy="'WaveformOutput-' + electricalParameter + '-thd-text'" class="fs-5 bg-dark text-white float-end" style="width: 100%; max-width: 60px; text-align:right;">{{thd}}</label>
