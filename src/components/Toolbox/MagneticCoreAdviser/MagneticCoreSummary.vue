...
<template>
    <div class="container">
        <div class="row">
            ...
            <div v-if="masStore.mas.magnetic.manufacturerInfo != null" class="col-12 md:col-10 text-start pr-0 row">
                <h3 class="col-12 p-0 m-0 pl-3">{{masStore.mas.magnetic.manufacturerInfo.reference}}</h3>
                <div class="col-12 text-xl p-0 m-0 mt-2 text-start pl-3">{{localTexts.coreDescription}}</div>
                ...
                <div class="col-12 text-xl p-0 m-0 mt-4 text-start pl-3">{{localTexts.numberTurns}}</div>
                <div class="sm:col-offset-0 md:col-offset-1 md:col-4 sm:col-11 row mt-3" v-for="(operationPoint, operationPointIndex) in masStore.mas.inputs.operatingPoints" :key="operationPointIndex">
                    ...
                    <div v-if="'magnetizingInductanceTable' in localTexts" class="col-4 p-0 m-0 border text-end pr-1">{{localTexts.magnetizingInductanceTable[operationPointIndex].value}}</div>
                    ...
                    <div v-if="'coreLossesTable' in localTexts" class="col-4 p-0 m-0 border text-end pr-1">{{localTexts.coreLossesTable[operationPointIndex].value}}</div>
                    ...
                    <div v-if="'coreTemperatureTable' in localTexts" class="col-4 p-0 m-0 border text-end pr-1">{{localTexts.coreTemperatureTable[operationPointIndex].value}}</div>
                    ...
                    <div v-if="'dcResistanceTable' in localTexts" class="col-4 p-0 m-0 border text-end pr-1">{{localTexts.dcResistanceTable[operationPointIndex].value}}</div>
                    ...
                    <div v-if="'windingLossesTable' in localTexts" class="col-4 p-0 m-0 border text-end pr-1">{{localTexts.windingLossesTable[operationPointIndex].value}}</div>
                </div>
            </div>
