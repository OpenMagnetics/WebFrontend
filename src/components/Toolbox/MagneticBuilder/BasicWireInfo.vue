        ...
        calculateWireData() {
            if (this.masStore.mas.magnetic.coil.functionalDescription[this.windingIndex].wire != "" &&
                ...
                this.$mkf.ready.then(_ => {
                    ...
                    this.effectiveCurrentDensity = this.$mkf.calculate_effective_current_density(wireString, currentString, this.masStore.mas.inputs.operatingPoints[0].conditions.ambientTemperature) / 1000000;
