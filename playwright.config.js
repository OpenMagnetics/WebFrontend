...
const projects = [
  ...
  },
  {
    name: 'wizards-light',
    testDir: './tests',
    testIgnore: ['scenarios/**', 'wizards/**', 'magnetic-builder-battery.spec.js', 'dab-wizard-battery.spec.js'],
  ...
  },
  {
    ...
    testDir: './tests',
    grep: /@heavy/,
    testMatch: ['scenarios/**/*.spec.js', 'wizards/**/*.spec.js', 'dab-wizard-battery.spec.js'],
    use: common,
  },
];
